...
func TestGitHub(t *testing.T) {
	...
	if err := report.GitHub(&out, sample()); err != nil {
		t.Fatal(err)
	}
...
func TestMarkdownIsPadded(t *testing.T) {
	var out bytes.Buffer
	if err := report.Markdown(&out, sample()); err != nil {
		t.Fatal(err)
	}
...
func TestMarkdownOnACleanRun(t *testing.T) {
	var out bytes.Buffer
	if err := report.Markdown(&out, report.New(results{name: "godoc"})); err != nil {
		t.Fatal(err)
	}
...
func TestIsTerminal(t *testing.T) {
	if report.IsTerminal(&bytes.Buffer{}) {
...
func TestTerminalDraws(t *testing.T) {
	var out bytes.Buffer
	if err := report.Terminal(&out, sample()); err != nil {
		t.Fatal(err)
	}
